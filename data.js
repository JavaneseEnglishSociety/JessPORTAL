...
function rawDefaultData() {
  ...
  return {
    ...
    // The impact dashboard shown at the very top of the homepage, before
    // anything else. Every visual is drawn as inline SVG generated by
    // script.js rather than by a charting library: no external
    // dependency to load, nothing to pay for, works on a slow
    // connection, and it renders identically offline once the page is
    // cached. Each block is independently editable in the admin panel.
    impact: {
      enabled: true,
      title: "Our impact so far",
      title_id: "Dampak kami sejauh ini",
      subtitle: "Free English education, taught by students, across Java.",
      subtitle_id: "Pendidikan Bahasa Inggris gratis, diajar oleh pelajar, di seluruh Jawa.",
      blocks: [
        { id: uid(), type: "bigNumber", label: "Students taught", label_id: "Siswa diajar", value: 500, suffix: "+", color: "green" },
        { id: uid(), type: "bigNumber", label: "Volunteer teachers", label_id: "Relawan pengajar", value: 30, suffix: "+", color: "blue" },
        { id: uid(), type: "bigNumber", label: "Classes run", label_id: "Kelas terlaksana", value: 120, suffix: "", color: "gold" },
        { id: uid(), type: "trend", label: "Students this term", label_id: "Siswa semester ini", value: 180, previous: 140, color: "green" },
        { id: uid(), type: "progress", label: "Toward 1,000 students", label_id: "Menuju 1.000 siswa", value: 500, goal: 1000, color: "green" },
        { id: uid(), type: "gauge", label: "Volunteer retention", label_id: "Relawan bertahan", value: 82, max: 100, suffix: "%", color: "blue" },
        { id: uid(), type: "donut", label: "Students by level", label_id: "Siswa per tingkat",
          series: [ { label: "Beginner", value: 260, color: "green" }, { label: "Intermediate", value: 170, color: "blue" }, { label: "Advanced", value: 70, color: "gold" } ] },
        { id: uid(), type: "pie", label: "Where our students are", label_id: "Asal siswa kami",
          series: [ { label: "Bekasi", value: 210, color: "green" }, { label: "Jakarta", value: 130, color: "blue" }, { label: "Bandung", value: 90, color: "gold" }, { label: "Other", value: 70, color: "coral" } ] },
        { id: uid(), type: "barsV", label: "Students per term", label_id: "Siswa per semester",
          series: [ { label: "2024 A", value: 60 }, { label: "2024 B", value: 95 }, { label: "2025 A", value: 130 }, { label: "2025 B", value: 165 }, { label: "2026 A", value: 180 } ], color: "green" },
        { id: uid(), type: "barsH", label: "Most requested topics", label_id: "Topik paling diminati",
          series: [ { label: "Speaking", value: 88 }, { label: "Vocabulary", value: 74 }, { label: "Grammar", value: 55 }, { label: "Writing", value: 40 } ], color: "blue" },
        { id: uid(), type: "line", label: "Growth in students", label_id: "Pertumbuhan siswa",
          series: [ { label: "2022", value: 40 }, { label: "2023", value: 110 }, { label: "2024", value: 240 }, { label: "2025", value: 380 }, { label: "2026", value: 500 } ], color: "green" },
        { id: uid(), type: "area", label: "Classes delivered", label_id: "Kelas terselenggara",
          series: [ { label: "Jan", value: 8 }, { label: "Feb", value: 12 }, { label: "Mar", value: 15 }, { label: "Apr", value: 14 }, { label: "May", value: 19 }, { label: "Jun", value: 23 } ], color: "blue" },
        { id: uid(), type: "stacked", label: "Volunteers by department", label_id: "Relawan per departemen",
          series: [ { label: "Academics", value: 12, color: "green" }, { label: "Media", value: 8, color: "blue" }, { label: "PR", value: 6, color: "gold" }, { label: "Internal", value: 4, color: "coral" } ] },
        { id: uid(), type: "ranked", label: "Partner schools by students", label_id: "Sekolah mitra menurut siswa",
          series: [ { label: "SMP Islam Al Azhar 8", value: 120 }, { label: "PYI Kemang Pratama", value: 95 }, { label: "Panti Marhamah Robbani", value: 60 }, { label: "SMA Harapan Bangsa", value: 45 } ], color: "green" },
        { id: uid(), type: "pictogram", label: "Every icon is 10 students", label_id: "Satu ikon mewakili 10 siswa", value: 500, perIcon: 10, icon: "🧑‍🎓", color: "green" },
        { id: uid(), type: "compare", label: "Confidence speaking English", label_id: "Percaya diri berbahasa Inggris",
          beforeLabel: "Before", afterLabel: "After", beforeValue: 28, afterValue: 79, suffix: "%" },
        { id: uid(), type: "heatgrid", label: "Class activity this year", label_id: "Aktivitas kelas tahun ini",
          series: [2,0,3,4,1,0,2,5,3,2,4,1,0,3,5,4,2,1,3,4,0,2,5,3,1,4,2,0,3,5,2,1,4,3,0,2,5,1,3,4,2,0,1,5,3,2,4,1,0,3,2,5], color: "green" },
        { id: uid(), type: "timeline", label: "Milestones", label_id: "Tonggak pencapaian",
          series: [ { label: "JESS founded", value: "2022" }, { label: "First 100 students", value: "2023" }, { label: "JessEDU launched", value: "2025" }, { label: "First EduTrip", value: "2026" } ] },
        { id: uid(), type: "sparkline", label: "Weekly sign-ups", label_id: "Pendaftaran mingguan",
          series: [ { label: "W1", value: 4 }, { label: "W2", value: 7 }, { label: "W3", value: 6 }, { label: "W4", value: 11 }, { label: "W5", value: 9 }, { label: "W6", value: 14 } ], color: "blue" }
      ]
    },
...
function normalizeData(data) {
  ...
  // Impact dashboard: merge shallowly so a site saved before this
  // existed still gets the full default set of visuals, while any
  // blocks the admin has already customised are kept exactly as they
  // are rather than being reset back to the samples.
  const defImpact = rawDefaultData().impact;
  d.impact = Object.assign({}, defImpact, d.impact || {});
  if (!Array.isArray(d.impact.blocks) || !d.impact.blocks.length) {
    d.impact.blocks = defImpact.blocks;
  }
  d.impact.blocks = d.impact.blocks.map((b) => ({
    id: b.id || uid(),
    type: b.type || "bigNumber",
    label: b.label || "",
    label_id: b.label_id || "",
    color: b.color || "green",
